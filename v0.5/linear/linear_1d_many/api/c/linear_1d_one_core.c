...
int linear_set_addr( unsigned long int base)
{
    CSRA_LINEAR1D_BASE=base;

    CSRA_LINEAR1D_VERSION           =(base+0x00);
    CSRA_LINEAR1D_CONTROL           =(base+0x10);
    CSRA_LINEAR1D_CONFIG            =(base+0x14);
    CSRA_LINEAR1D_CONFIG_FIFO       =(base+0x18);
    
    CSRA_LINEAR1D_INPUT_ADDR_LOW    =(base+0x20);
    CSRA_LINEAR1D_INPUT_ADDR_HIGH   =(base+0x24);
    CSRA_LINEAR1D_INPUT_CFG         =(base+0x28);
    CSRA_LINEAR1D_INPUT_BURST       =(base+0x30);
    
    CSRA_LINEAR1D_WEIGHT_ADDR_LOW   =(base+0x40);
    CSRA_LINEAR1D_WEIGHT_ADDR_HIGH  =(base+0x44);
    CSRA_LINEAR1D_WEIGHT_CFG        =(base+0x48);
    CSRA_LINEAR1D_WEIGHT_ITEMS      =(base+0x4C);
    CSRA_LINEAR1D_WEIGHT_BURST      =(base+0x50);
    
    CSRA_LINEAR1D_BIAS_ADDR_LOW     =(base+0x60);
    CSRA_LINEAR1D_BIAS_ADDR_HIGH    =(base+0x64);
    CSRA_LINEAR1D_BIAS_CFG          =(base+0x68);
    
    CSRA_LINEAR1D_RST_ADDR_LOW      =(base+0x70);
    CSRA_LINEAR1D_RST_ADDR_HIGH     =(base+0x74);
    CSRA_LINEAR1D_RST_CFG           =(base+0x78);
    CSRA_LINEAR1D_RST_BURST         =(base+0x80);
    
    CSRA_LINEAR1D_LINEAR_ACTIV_FUNC =(base+0x90);
    CSRA_LINEAR1D_LINEAR_ACTIV_PARAM=(base+0x94);
    
    CSRA_LINEAR1D_PROFILE_CTL       =(base+0xA0);
    CSRA_LINEAR1D_PROFILE_CYCLES    =(base+0xA4);
    CSRA_LINEAR1D_PROFILE_MAC_NUM   =(base+0xA8);
    CSRA_LINEAR1D_PROFILE_MAC_OVR   =(base+0xAC);
    CSRA_LINEAR1D_PROFILE_BIA_OVR   =(base+0xB0);
    CSRA_LINEAR1D_PROFILE_ACT_OVR   =(base+0xB4);
    CSRA_LINEAR1D_PROFILE_CNT_RD    =(base+0xB8);
    CSRA_LINEAR1D_PROFILE_CNT_WR    =(base+0xBC);
