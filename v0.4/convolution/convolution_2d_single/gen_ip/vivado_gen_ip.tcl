...
set_property verilog_dir "../../../mac/mac_float/core/${FPGA_TYPE}/${VIVADO_VER}" [current_fileset]

read_verilog  "../rtl/verilog/convolution_2d.v
...
ipx::package_project -root_dir . -vendor future-ds.com\
                     ...
                     -import_files "../rtl/verilog/convolution_2d.v
                                    ../../../mac/mac_float/rtl/verilog/mac_core.v
                                    ../../../mac/tree_mac/rtl/verilog/tree_mac.v"
