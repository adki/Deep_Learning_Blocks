   ...
   if (RESET_N==1'b0) begin
      ...
      if (T_RDEN) begin
         ...
         case (T_ADDR) // synthesis full_case parallel_case
           ...
           CSRA_SRCA_ADDR_HIGH: T_RDATA <= (AXI_WIDTH_AD>32)
                                        ? csr_srcA_address[AXI_WIDTH_AD-1:32]
                                        : 32'h0;
           ...
           CSRA_SRCB_ADDR_HIGH: T_RDATA <= (AXI_WIDTH_AD>32)
                                        ? csr_srcB_address[AXI_WIDTH_AD-1:32]
                                        : 32'h0;
