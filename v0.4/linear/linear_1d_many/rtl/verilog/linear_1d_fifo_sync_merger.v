...
module linear_1d_fifo_sync_merger
     #(parameter FDW=32
               , FAW=$clog2(16)
               , FEN=(FDW/8)
               , DEPTH=(1<<FAW)
...
(
    ...
    `endif
    //--------------------------------------------------------------------------
    linear_1d_fifo_sync_merger_push #(.FDW(FDW),.FEN(FEN))
    u_push (
          .rstn    (   rstn    )
        , .clr     (   clr     )
        , .clk     (   clk     )
    ...
    //--------------------------------------------------------------------------
    linear_1d_fifo_sync_merger_core #(.FDW(1+FEN+FDW),.FAW(FAW))
    u_fifo (
          .rstn     (   rstn                        )
        , .clr      (   clr                         )
        , .clk      (   clk                         )
    ...
    //--------------------------------------------------------------------------
    linear_1d_fifo_sync_merger_pop #(.FDW(FDW),.FEN(FEN))
    u_pop (
          .rstn    (   rstn    )
        , .clr     (   clr     )
        , .clk     (   clk     )
...
//    --+--+--+--+    --+--+--+--+
//
module linear_1d_fifo_sync_merger_push
     #(parameter FDW=32
               , FEN=(FDW/8)
               )
(
...
//    --+--+--+--+    --+--+--+--+
//
module linear_1d_fifo_sync_merger_pop
     #(parameter FDW=32
               , FEN=(FDW/8)
               )
(
...
module linear_1d_fifo_sync_merger_core
