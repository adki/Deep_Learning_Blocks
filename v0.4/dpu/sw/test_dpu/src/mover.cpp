...
//------------------------------------------------------------------------------
int test_mover_2d_fill( __attribute__((unused)) int test_level
                      , int verbose )
{
...
#ifndef  ADDR_MEMORY_START
//#warning ADDR_MEMORY_START should be defined.
#define  ADDR_MEMORY_START 0x00000000
#endif

    uint64_t hw_addr = ADDR_MEMORY_START;
...
//------------------------------------------------------------------------------
int test_mover_2d_copy( int test_level, int verbose )
{
    #if defined(DEBUG)
    mover_version();
    mover_csr_test();
...
#define  ADDR_MEMORY_START 0x00000000
    ...
    TYPE *hw_src_addr = ADDR_MEMORY_START;
...
//------------------------------------------------------------------------------
int test_mover_2d_residual( int test_level, int verbose )
{
    #if defined(DEBUG)
    mover_version();
    mover_csr_test();
...
#define  ADDR_MEMORY_START 0x00000000
    ...
    uint16_t height=11;
    uint32_t align_size = ((width*height+3)/4)*4;
    TYPE *hw_srcA_addr = ADDR_MEMORY_START;
...
//------------------------------------------------------------------------------
int test_mover_2d_concat0( int test_level, int verbose )
{
    #if defined(DEBUG)
    mover_version();
    mover_csr_test();
...
//------------------------------------------------------------------------------
int test_mover_2d_concat1( int test_level, int verbose )
{
    #if defined(DEBUG)
    mover_version();
    mover_csr_test();
