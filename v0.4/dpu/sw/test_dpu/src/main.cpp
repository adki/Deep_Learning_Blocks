...
int test_pool=1;
int test_linear=1;
int test_mover_fill=1;
int test_mover_copy=1;
int test_mover_residual=1;
int test_mover_concat0=1;
int test_mover_concat1=1;
...
int main(int argc, char* argv[])
{
    ...
    extern int  test_convolution_2d( int test_level, int verbose );
    extern int  test_pooling_2d( int test_level, int verbose );
    extern int  test_linear_1d( int test_level, int verbose );
    extern int  test_mover_2d_fill( int test_level, int verbose );
    extern int  test_mover_2d_copy( int test_level, int verbose );
    extern int  test_mover_2d_residual( int test_level, int verbose );
    extern int  test_mover_2d_concat0( int test_level, int verbose );
    extern int  test_mover_2d_concat1( int test_level, int verbose );
    ...
    if (test_conv>0) {
        test_convolution_2d( test_level, verbose );
    }
    if (test_pool>0) {
        test_pooling_2d( test_level, verbose );
    }
    if (test_linear>0) {
        test_linear_1d( test_level, verbose );
    }
    if (test_mover_fill>0) {
        test_mover_2d_fill( test_level, verbose );
    }
    if (test_mover_copy>0) {
        test_mover_2d_copy( test_level, verbose );
    }
    if (test_mover_residual>0) {
        test_mover_2d_residual( test_level, verbose );
    }
    if (test_mover_concat0>0) {
        test_mover_2d_concat0( test_level, verbose );
    }
    if (test_mover_concat1>0) {
        test_mover_2d_concat1( test_level, verbose );
    }
